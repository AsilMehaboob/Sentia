    ...
    <header className="bg-black z-50">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <div className="flex lg:hidden">
          <button
            ...
            className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white transition duration-200 ease-in-out transform"
          >
      ...
      <Dialog open={mobileMenuOpen} onClose={() => setMobileMenuOpen(false)} className="lg:hidden">
        <motion.div
          ...
          className="fixed inset-0 z-40"  // Ensure this is above other content
        />
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="-m-2.5 rounded-md p-2.5 text-gray-700 transition duration-200 ease-in-out transform"
            >
